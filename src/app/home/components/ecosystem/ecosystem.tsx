        ...
        <div className={` d-flex justify-content-center  align-items-center  ${styles.container}`}>
            <div className={`d-flex  justify-content-center  align-items-center  justify-content-between ${styles.imagecontainer}`}>
                <Image
                    ...
                    height={403}
                />
                <div className={` d-flex flex-column mt-5 ${styles.content}`}>
                    ...
                    <div className={styles.content1}>
                        ...
                        <span>  </span>
                        Our value proposition<span>provides peace of mind through a robust, risk-resistant supply chain, ensuring seamless operations.</span>
                    </div>
